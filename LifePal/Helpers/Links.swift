...
struct Links {
    ...
    static let menuRecommendationAPI = "http://3.15.22.210:8000/api/foodrec/?weight=$weight$&bodyfat=$bodyfat$&avg_activity=$avg_activity$&cb=2&cl=2&cd=2"
    static let fullMenuAPI = "http://3.15.22.210:8000/api/menu"
    static let waterRecommendationAPI =
        "http://3.15.22.210:8000/api/waterrec/?age=$age$&weight=$weight$&height=$height$&avg_activity=$avg_activity$&temperature=$temperature$"
